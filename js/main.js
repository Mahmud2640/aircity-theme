(function ($) {
  ...
  $(function () {
    ...
    $(".dropdown-text").on("click", function () {
      if (
        $(this).parent().find(".dropdown-language").hasClass("hide") === false
      ) {
    ...
    $("body").on("click", function (event) {
      if (
        $(".dropdown-text").has(event.target).length === 0 &&
        !$(".dropdown-text").is(event.target)
      ) {
        $(".dropdown-language").addClass("hide");
      }
    });
  ...
  $(function () {
    ...
    $(".dropdown-text").on("click", function () {
      if (
        $(this).parent().find(".dropdown-monney").hasClass("hide") === false
      ) {
    ...
    $("body").on("click", function (event) {
      if (
        $(".btn-search").has(event.target).length === 0 &&
        !$(".btn-search").is(event.target) &&
  ...
  if (
    $(".header-default").hasClass("header-style-1") ||
    $(".header-default").hasClass("header-style-2")
  ) {
  ...
  $(function () {
    ...
    $(".animated-Fade-In-Up-1")
      .addClass("fadeInUp")
      .attr("data-wow-delay", "0.2s");
    $(".animated-Fade-In-Up-2")
      .addClass("fadeInUp")
      .attr("data-wow-delay", "0.4s");
    $(".animated-Fade-In-Up-3")
      .addClass("fadeInUp")
      .attr("data-wow-delay", "0.6s");
    $(".animated-Fade-In-Up-4")
      .addClass("fadeInUp")
      .attr("data-wow-delay", "0.8s");
    $(".animated-Fade-In-Up-5")
      .addClass("fadeInUp")
      .attr("data-wow-delay", "1s");
    $(".animated-Fade-In-Up-6")
      .addClass("fadeInUp")
